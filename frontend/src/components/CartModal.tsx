...
const CartModal = forwardRef((props, ref) => {
  ...
  return (
    <dialog
      ref={dialogRef}
      title="Cart"
      className="w-2/5 h-2/5 bg-blueGray-800 text-zinc-300 rounded-xl border-solid border-4 border-orange-400"
    >
      <form method="dialog">
        <h2 className="text-3xl my-6 font-bold">Orders</h2>
        <div className="flex flex-row gap-40 justify-center text-2xl mx-3">
